...
/**
 *  Figure for the switch instruction.
 *
 * @author Sergej Alekseev 
 *  @version $Revision:143 $
 *  $Id:SwitchVertexFigure.java 143 2007-05-28 10:10:03Z aleks $
 */
public class SwitchVertexFigure extends Shape {
	 ...
	 */
	public SwitchVertexFigure(boolean useGradientFillColor){
...
//	    graphics.drawPolygon(getPoints(r));
	...
	private static PointList getPoints(Rectangle r){
	    ...
	    pl.addPoint(r.x + r.width -  r.width/4, r.y + r.height - 1);
	    pl.addPoint(r.x + r.width/4, r.y + r.height - 1);
	...
	private static PointList getPointsOutsideLeft(Rectangle r){
		...
		pl.addPoint(r.x + r.width/4, r.y);
		pl.addPoint(r.x, r.y + r.height/2);
		pl.addPoint(r.x + r.width/4, r.y + r.height);
	...
	private static PointList getPointsOutsideRight(Rectangle r){
		...
		pl.addPoint(r.x +  r.width -  r.width/4, r.y + r.height);
		pl.addPoint(r.x +  r.width, r.y + r.height/2);
