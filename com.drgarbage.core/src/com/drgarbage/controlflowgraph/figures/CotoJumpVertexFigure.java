 ...
 * $Id:CotoJumpVertexFigure.java 143 2007-05-28 10:10:03Z aleks $
 */
public class CotoJumpVertexFigure extends Shape {

	private boolean useGradientFillColor;
	
	/**
	 * Constructor sets default color.
	 * @param useGradientFillColor
	 */
	public CotoJumpVertexFigure(boolean useGradientFillColor){
...
//	    }
	...
	private static PointList getPointsOutsideRight(Rectangle r){
	    ...
	    pl.addPoint(r.x +  r.width/2 + r.width/4, r.y + r.height);
